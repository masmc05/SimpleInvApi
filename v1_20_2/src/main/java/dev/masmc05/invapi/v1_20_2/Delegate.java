...
import dev.masmc05.invapi.v1_20_2.menus.ChestMenu;
import dev.masmc05.invapi.v1_20_2.menus.DispenserMenu;
...
public class Delegate {
    public static boolean isSupported() {
        try {
            return SharedConstants.getCurrentVersion().getId().equals("1.20.2");
        } catch (Throwable t) {
            return false;
        }
    }
